...
test("1. Reserved System Role Names check: POST /roles with name 'owner' is rejected (409 ConflictError)", async () => {
  ...
  test("1a. GET /api/v1/roles/permissions/catalog returns permissions grouped by module (32 keys)", async () => {
    ...
    const menuModule = body.data.find((g) => g.module === "menu");
